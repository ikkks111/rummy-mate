                        ...
                        <SimpleGrid columns={12} columnGap={4} rowGap={4}>
                            <GridItem colSpan={[12, 12, 5, 5, 3]} className=' '>
                                <Box className='big_bons'>
                                    <img src='/img/big_bonuses_bg.png' alt='' className='big_bonuses_bg' />
                                    <Box className='big_bonsInnr'>
                                        <img src='/img/flash_img.png' alt='' className='flash_img'/>
                                ...
                                <SimpleGrid columns={12} columnGap={[4]} rowGap={4}>
                                    <GridItem colSpan={[12, 12, 12, 12]} className=''>
                                        <Box className='inst_wdrollBG'>
                                            <img src='/img/Instant_withdrawal_bg.png' alt='' className='Instant_withdrawal_bg'/>
                                            <Box className='inst_innr'>
                                                <img src='/img/money-send.png' alt='' className='flash_img'/>
                                                <Box>
                                    ...
                                    <GridItem colSpan={[12, 12, 12, 12]} className=''>
                                        <Box className='inst_wdrollBG'>
                                            <img src='/img/total_safety_bg.png' alt='' className='Instant_withdrawal_bg'/>
                                            <Box className='inst_innr'>
                                                <img src='/img/verify.png' alt='' className='flash_img'/>
                                                <Box>
                ...
                <Box className='slidr-main'>
                    <Slider {...settings}>
                        <div className='slidr-items'>
                            <img src='/img/slider_img01.png' alt='' className='big_img_slider'/>
                        </div>
                        <div className='slidr-items'>
                            <img src='/img/slider_img02.png' alt='' className='big_img_slider'/>
                        </div>
                        <div className='slidr-items'>
